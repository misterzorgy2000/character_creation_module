...
def special(char_name: str, char_class: str) -> str:
    """Функция применения специальных навыков."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    ...
    print(
        'Введи одну из команд: attack — чтобы атаковать противника, defenc'
        'e — чтобы блокировать атаку противника или '
